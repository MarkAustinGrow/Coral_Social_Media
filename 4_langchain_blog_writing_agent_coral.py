...
async def main():
    ...
    async with MultiServerMCPClient(
        ...
        logger.info("Starting Blog Writing Agent (Coral Protocol) execution with optimized API usage")
        log_to_database("info", "Starting Blog Writing Agent (Coral Protocol) execution with optimized API usage")
